...
export default function FarmerResources() {
  ...
  return (
    <div className="space-y-12 animate-in fade-in duration-500">
      {/* Intro Banner */}
      <div className="bg-emerald-50/70 border border-emerald-200/60 rounded-3xl p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="space-y-2 text-center md:text-left">
          ...
          <h2 className="text-2xl md:text-3xl font-black text-slate-800">
            🏛️ Government Schemes & Farmer E-Services
          </h2>
          <p className="text-slate-600 font-medium text-sm md:text-base max-w-3xl">
            Verified official portals for PM-KISAN, Land Records (AnyRoR), e-KYC, Food Security, and central agricultural welfare programs.
          </p>
        </div>
        <a
          ...
          className="inline-flex items-center gap-2 px-6 py-3.5 bg-[#2e6b3b] hover:bg-[#1b5e20] text-white font-bold rounded-full shadow-lg shadow-emerald-200 text-sm shrink-0 transition-all hover:scale-105"
        >
