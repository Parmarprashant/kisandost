...
export const products: Product[] = [
  ...
  },
  {
    ...
    color: "#B8860B",
    price: 450,
    imageUrl: "https://cdn.shopify.com/s/files/1/0722/2059/files/royal-clear-mite-organic-acaricide-miticide-file-5156.jpg?v=1737431407&width=640&format=webp"
  },
  {
  id: 19,
  name: "Miticide + Lysorus Viricide Combo",
  tag: "Crop Protection Combo",
  description: "A powerful combination of miticide and viricide to protect crops from mites and viral diseases.",
  longDescription: "Miticide + Lysorus Viricide Combo by Katra Fertilizers and Chemicals Pvt Ltd is designed to provide dual protection against harmful mites and viral infections in crops. It helps in reducing pest infestation, improving plant health, and ensuring better yield quality. Ideal for integrated pest and disease management in agriculture.",
  features: [
    "Effective control of mites and viral diseases",
    "Improves overall plant health",
    "Enhances crop yield and quality",
    "Suitable for multiple crops",
    "Dual-action protection formula"
  ],
  usage: {
    foliar_spray: "2-3 ml per liter of water (or as recommended)",
    drip_irrigation: "Not typically used via drip; follow expert guidance"
  },
  translationKey: "MiticideViricideCombo",
  color: "#2E8B57",
  price: 1210,
  imageUrl: "https://cdn.shopify.com/s/files/1/0722/2059/files/katra-botanical-miticide-lysorus-anti-virus-anti-bacteria-file-13747.jpg?v=1737448949&width=640&format=webp"
},
{
  id: 20,
  name: "Tapas Silicon Adjuvant",
  tag: "Silicon-Based Adjuvant",
  description: "A silicon-based adjuvant that enhances pesticide efficiency and strengthens plant defense.",
  longDescription: "Tapas Silicon Adjuvant is a specialized agricultural adjuvant enriched with silicon that improves the effectiveness of pesticides and foliar sprays. It forms a protective layer on plant surfaces, helping reduce pest and disease impact while enhancing plant strength and stress tolerance. It also improves spray coverage and absorption for better results.",
  features: [
    "Enhances effectiveness of pesticides and fertilizers",
    "Improves spray coverage and absorption",
    "Strengthens plant cell walls",
    "Increases resistance to pests and diseases",
    "Reduces water loss and improves stress tolerance"
  ],
  usage: {
    foliar_spray: "0.5-1 ml per liter of water (or as recommended)",
    drip_irrigation: "Generally not used via drip; follow expert advice"
  },
  translationKey: "TapasSiliconAdjuvant",
  color: "#4682B4",
  price: 650,
  imageUrl: "https://cdn.shopify.com/s/files/1/0722/2059/files/tapas-sticking-and-spreading-agent-file-6068.webp?v=1737472012&width=640&format=webp"
}
];
