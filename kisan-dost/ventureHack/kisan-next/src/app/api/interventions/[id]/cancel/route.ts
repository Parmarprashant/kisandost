...
/**
 * PATCH /api/interventions/[id]/cancel
 * Farmer cancels a scheduled intervention.
...
export async function PATCH(req: Request, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    console.error('[PATCH /api/interventions/[id]/cancel] Error:', error);
    return NextResponse.json({ error: error.message || 'Failed to cancel intervention' }, { status: 500 });
  }
}
